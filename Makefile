...
clean: down
	...
	@sudo rm -rf srcs/auth_db/data \
		...
		srcs/authentication/srcs/authentication/__pycache__ \
		srcs/hashi_vault/token/.vault-token \
		srcs/game_front/srcs/node_modules \
		srcs/game_front/srcs/dist \
		srcs/game_front/srcs/package-lock.json \
		srcs/game_front/srcs/public/models/.DS_Store
