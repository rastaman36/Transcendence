...
function createBackground() {
    ...
    cubeTextureLoader.load([
        '/tournament/models/cube_right.png',   // positive x
        '/tournament/models/cube_left.png',    // negative x
        '/tournament/models/cube_up.png',     // positive y
        '/tournament/models/cube_down.png',  // negative y
        '/tournament/models/cube_back.png',   // positive z
        '/tournament/models/cube_front.png'     // negative z
    ], (cubeTexture) => {
...
async function initWebsocket() {
    ...
    socket = new WebSocket(`wss://www.transc-net.com/game/localtournament/`);
