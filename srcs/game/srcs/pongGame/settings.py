...
# django-insecure-fbis$45w)b6rav&krehym&4%mtbh@44!m97xs1((reucbi(^t(

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.getenv("GAME_DEBUG")
...
CHANNEL_LAYERS = {
    'default': {
        ...
        "CONFIG": {
            "capacity": 1000,  # Increase the capacity
            "expiry": 30,      # Adjust message expiry time if needed
        },
    }
}
# Database
